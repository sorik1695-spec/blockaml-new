...
// -------------------- 1. ИНИЦИАЛИЗАЦИЯ (РАБОЧИЙ СПОСОБ) --------------------
const tronWeb = new TronWeb(
    process.env.TRONGRID_API,
    process.env.TRONGRID_API,
    process.env.TRONGRID_API,
    process.env.BOT_PRIVATE_KEY // Работает!
);
...
console.log('🔑 Ключ загружен, длина:', process.env.BOT_PRIVATE_KEY.length);
